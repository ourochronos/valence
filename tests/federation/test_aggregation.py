...
from valence.federation.models import FederatedBelief, Visibility, ShareLevel
...
class TestIntegration:
    ...
    def test_full_aggregation_pipeline(self) -> None:
        ...
        aggregator = FederationAggregator(config=config)
        result = aggregator.aggregate(
            [anchor_contrib, regular_contrib_a, regular_contrib_b, 
             extra_contrib_c, extra_contrib_d, extra_contrib_e],
