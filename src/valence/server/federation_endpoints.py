...
async def verify_did_signature(request: Request) -> dict[str, Any] | None:
    ...
    try:
        from our_federation.identity import resolve_did_sync, verify_signature
...
async def federation_protocol(request: Request) -> JSONResponse:
    ...
    try:
        ...
        from our_federation.protocol import handle_message, parse_message
...
async def federation_nodes_get(request: Request) -> JSONResponse:
    ...
    from our_federation.tools import federation_node_get
...
async def federation_nodes_discover(request: Request) -> JSONResponse:
    ...
    try:
        ...
        from our_federation.tools import federation_node_discover
...
async def federation_trust_get(request: Request) -> JSONResponse:
    ...
    from our_federation.tools import federation_trust_get as get_trust
...
async def federation_trust_set(request: Request) -> JSONResponse:
    ...
    try:
        ...
        from our_federation.tools import federation_trust_set_preference
...
async def federation_sync_status(request: Request) -> JSONResponse:
    ...
    from our_federation.tools import federation_sync_status as get_sync_status
...
async def federation_sync_trigger(request: Request) -> JSONResponse:
    ...
    try:
        ...
        from our_federation.tools import federation_sync_trigger as trigger_sync
...
async def federation_belief_share(request: Request) -> JSONResponse:
    ...
    try:
        ...
        from our_federation.tools import federation_belief_share as share_belief
...
async def federation_belief_query(request: Request) -> JSONResponse:
    ...
    try:
        ...
        from our_federation.tools import federation_belief_query as query_beliefs
