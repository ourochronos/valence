...
class NodeClient:
    ...
    oob_verification_url: str | None = None
    ...
    on_ack_timeout: Callable[[str, str], None] | None = None
    on_state_recovered: Callable[[ConnectionState], None] | None = None
    ...
    on_router_flagged: Callable[[str, Any], None] | None = None
    ...
    _connection_manager: ConnectionManager | None = field(default=None, repr=False)
    _message_handler: MessageHandler | None = field(default=None, repr=False)
    _router_client: RouterClient | None = field(default=None, repr=False)
    ...
    def _select_router(self, exclude_back_pressured: bool = True) -> RouterInfo | None:
    ...
    async def _load_state(self) -> ConnectionState | None:
        ...
        if state.node_id != self.node_id:
            raise StateConflictError("State file belongs to different node")
